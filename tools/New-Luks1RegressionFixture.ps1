...
$generator = [IO.Path]::GetFullPath((Join-Path $PSScriptRoot 'new-luks1-regression-fixture.sh'))
if (-not (Test-Path -LiteralPath $generator -PathType Leaf)) {
    throw "LUKS1 fixture generator was not found: $generator"
}
...
try {
    ...
    if ($LASTEXITCODE -ne 0) {
        throw "LUKS1 fixture generation failed with exit code $LASTEXITCODE."
    }
