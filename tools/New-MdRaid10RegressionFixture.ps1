param(
    [string]$OutputDirectory = (Join-Path $PSScriptRoot '..\.tmp\real-images\mdraid10'),
...
$generator = [IO.Path]::GetFullPath((Join-Path $PSScriptRoot 'new-md-raid10-regression-fixture.sh'))
if (-not (Test-Path -LiteralPath $generator -PathType Leaf)) {
    throw "Linux md RAID10 fixture generator was not found: $generator"
}

$outputs = 1..4 | ForEach-Object {
    [IO.Path]::Combine($resolvedOutputDirectory, "md-raid10-$_.raw")
}
...
if ($LASTEXITCODE -ne 0) {
    throw "Linux md RAID10 fixture generation failed with exit code $LASTEXITCODE."
}
